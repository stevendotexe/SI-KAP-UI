...
import {
    ...
    useQuery,
    useMutation,
} from "@tanstack/react-query" // <-- ADDED
...
export default function DashboardPage() {
    const queryClientRef = useRef(new QueryClient()) // <-- ADDED
 ...
 async function capturePhoto() {
    ...
    const handleCatatMasuk = async () => {
        ...
        await saveAttendanceMutation.mutateAsync({
            type: "masuk",
            imageName: masukImageName,
            ts,
            location: masukLocation,
        })
    ...
    const handleCatatKeluar = async () => {
        ...
        await saveAttendanceMutation.mutateAsync({
            type: "keluar",
            imageName: keluarImageName,
            ts,
            location: keluarLocation,
        })
                                                        ...
                                                        {!isMasukSaved && (
                                                            ...
                                                            >
                                                                ...
                                                                <span className="text-sm font-semibold">
                                                                    {saveAttendanceMutation.isPending ? "Menyimpan..." : "Catat Jam Masuk"}
                                                                </span>
                                                            </Button>
                                                        )}
                                                    </>
                                                    ...
                                                    <>
                                                        ...
                                                        {!isKeluarSaved && (
                                                            <Button
                                                                ...
                                                                disabled={!isMasukSaved || saveAttendanceMutation.isPending}
                                                            ...
                                                            >
                                                                <LogOut className="w-4 h-4" />
                                                                <span className="text-sm font-semibold">
                                                                    {saveAttendanceMutation.isPending ? "Menyimpan..." : "Catat Jam Keluar"}
                                                                </span>
                                                            </Button>
                                                        )}
                                                    </>
