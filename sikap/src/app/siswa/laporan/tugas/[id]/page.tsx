...
/**
 * Detail Tugas Page (Laporan Context)
 * 
 * This page displays task details when accessed from the Laporan page.
 * It keeps the sidebar active on "Laporan" menu while showing task information.
 */
export default function DetailTugasDariLaporanPage() {
