          ...
          <div className="rounded-xl border bg-white p-4 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-muted-foreground text-sm">Menunggu</div>
              </div>
            </div>
          </div>
          <div className="rounded-xl border bg-white p-4 shadow-sm">
          ...
          <div className="rounded-xl border bg-white p-4 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-muted-foreground text-sm">Ditolak</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-6">
          <div className="mb-4 flex flex-wrap items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              >
                <SelectTrigger className="w-[130px] rounded-full bg-white">
            ...
            <div className="space-y-3">
              {filteredEntries.map((entry) => (
                <div
                  ...
                  className={`cursor-pointer rounded-xl border bg-white p-4 shadow-sm transition-colors hover:border-red-200 ${
                    selectedDate === entry.activityDate
